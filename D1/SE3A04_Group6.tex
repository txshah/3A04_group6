...
\begin{enumerate}[{\bf BE1.}]
        ...
        \noindent \textbf{Pre-condition:} User has opened the application and is not logged in
            ...
            \begin{enumerate}
                \item User selects create an account from login page
                \item System provides user with fields to create a username and password
                \item System asks users to re-enter password for confirmation
                \item Account has been created and user is logged in on home page
            \end{enumerate}
