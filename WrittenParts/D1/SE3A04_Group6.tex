...
\begin{enumerate}[{\bf BE1.}]
        ...
        \begin{enumerate}[{\bf VP1.}]
            \item User \#1 \\
                ...
                \begin{itemize}
                    \item 5i. User enters empty field for username and selects enter
                    \begin{enumerate}
                        \item[5i.1] System prompts user to fill in username field and does not proceed.
                    \end{enumerate}
                    \item 5ii. User enters username already held by another user
                    \begin{enumerate}
                        \item[5ii.1] System prompts user to choose a different username
                        \item[5ii.2] System generates and offers similar potential usernames to the user
                    \end{enumerate}
                    \item 7i. User enters empty field for password and selects enter
                    \begin{enumerate}
                        \item[7i.1] System prompts user to fill in password field and does not proceed.
                    \end{enumerate}
                    \item 9i. User enters incorrect password and selects enter
                    \begin{enumerate}
                        \item[9i.1] System informs user that passwords do not match and prompts them to try again and does not proceed
                    \end{enumerate}
                \end{itemize}
        ...
        \noindent \textbf{Pre-condition:} User has opened the application and is not logged in
            ...
            \begin{enumerate}
                \item[1] User selects create an account from login page
                \item[2] System provides user with fields to create a username and password
                \item[3] System asks users to re-enter password for confirmation
                \item[4] Account has been created and user is logged in on home page
            \end{enumerate}
    
            \noindent \textbf{Secondary Scenarios:}
            \begin{itemize}
                \item If the user enters an already-taken username, the system prompts the user to use a different username and offers suggestions.
                \item If the user misenters information for the password field, the system prompts the user to try again and does not proceed.
            \end{itemize}
...
\textbf{Main Success Scenario:}
\begin{enumerate}
    \item[1] User selects "View Report" from the dashboard.
    \item[2] The system retrieves and displays the report information, including the animal's details such as species, habitat, and diet.
    \item[3] User reviews the report.
    \item[4] User may choose to share the report with the community.
\end{enumerate}
