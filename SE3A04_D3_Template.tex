...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{Forum.png}
	\caption{Forum Controller}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{GenerateReport.png}
	\caption{Generate Report Controller}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4]{AccountManager.png}
	\caption{Account Manager Controller}
\end{figure}
\clearpage 
% End Section
